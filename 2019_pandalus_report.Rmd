...
library(officer)          # helps flextable formatting transfer to Word
...
This section will include Table 1. Can I cross-reference it? Table \@ref(tab:test)
<!--
...
Table 1 through piping code via file = 

```{r test, file = 'scripts/Script_Table01_Sample-Locations.R', echo=FALSE}
#source("C:scripts/Script_Table01_Sample-Locations.R", local = knitr:knit_global())

#table01a
```


Table 1 through piping code via source
...
Cross reference test for Table\@ref(tab:table-kable)
...
Table 1 with Flextable package. Does captions and cross referencing work? Table \@ref(tab:flex)

```{r flex, echo = FALSE}
big_border <- fp_border(color = "darkgray", style = "solid" , width = 1.5)

table01d <-  flextable(samp.table) %>%
