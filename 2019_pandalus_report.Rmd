...
library(ggtext)             # allows for text formatting in ggplots
...
```{r shrimp percent, echo = FALSE, fig.cap="*Relative contribution by (a)  percent weight (%W) and (b) percent number (%N) of *P. borealis*, *P. montagui*, and unidentifiable *Pandalus sp.* within Arctic Cod (*Gadus morhua*), Greenland Halibut (*Reinhardtius hippoglossides*), redfish (*Sebastes sp.*), and skate (*Rajidae*) stomachs in comparison to other taxonomic categories of prey.*"}
...
ggplot(pandalus.percent, 
       aes(x = factor(other.prey, levels = c('Shrimp', 'other')),   # orders discrete data for figure
           y = pizza, 
           fill = factor(prey.name, levels = c('other', 'Pandalus', 'montagui', 'borealis')) # orders variables in bars
           )) +
  ...
  facet_wrap(~ pred.name,
             ...
             labeller = as_labeller(c("Atlantic cod" = "Atlantic<br>cod",
                                      "Greenland halibut" = "Greenland<br>halibut",
                                      "Redfish" = "Redfish",
                                      "Skate" = "Skate")
             ))+                      
...
#  scale_y_continuous(breaks = seq(0, 100, by = 25)) +
  ...
  scale_x_discrete(#labels = c("",""),
    expand = c(1, 1)) +                          # adds padding around the bars
