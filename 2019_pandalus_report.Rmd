...
```{r cod-shrimp-percent, echo = FALSE, file = "scripts/Script_Figure08_Padalus-percent-Cod.R", fig.height = 6, fig.width = 12, fig.cap="*Relative contribution of *P. borealis*, *P. montagui*, and unidentifiable *Pandalus sp.* by (a) weight (%W) and (b) number (%N) found within  Arctic Cod (*Gadus morhua*) stomachs in comparison to other taxonomic categories of prey*"}
...
```{r f8-option-B, echo = FALSE, fig.height = 6, fig.width = 12, fig.cap="*Fig 8 Option B*"}
...
```{r f8-option-C, echo = FALSE, fig.height = 6, fig.width = 12, fig.cap="*Fig 8 Option C*"}
...
```{r f8-option-D, echo = FALSE, fig.height = 6, fig.width = 12, fig.cap="*Fig 8 Option D*"}
