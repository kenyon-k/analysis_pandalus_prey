...
```{r shrimp percent, echo = FALSE, fig.height = 4, fig.width = 12, fig.cap="*Relative contribution by (a)  percent weight (%W) and (b) percent number (%N) of *P. borealis*, *P. montagui*, and unidentifiable *Pandalus sp.* within Arctic Cod (*Gadus morhua*), Greenland Halibut (*Reinhardtius hippoglossides*), redfish (*Sebastes sp.*), and skate (*Rajidae*) stomachs in comparison to other taxonomic categories of prey.*"}
