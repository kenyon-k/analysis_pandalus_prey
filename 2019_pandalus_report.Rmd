...
```{r sample-loc, echo=FALSE, fig.cap="*Number of stomach sampling locations within each depth stratum of the Eastern ASsessment Zone (EAZ), Western Assessment Zone (WAZ), and Shrimp Fishing Area 4 (SFA 4)*"}
...
# Tutorial and experimental codes for Table 1 are saved in (scripts/draft code/Draft_Script_Table01_sample-location.R).

# Additional notes on unused gt arguments are saved at the bottom of (Draft_Script_Table01_sample-location.R)
...
write.csv(samp.detail, 
          file="data/processed/2019rm_T1_sampleLocation_detailed.csv",
          row.names = FALSE)
...
write.csv(samp.table, 
          file="data/processed/2019rm_T1_sampleLocation_final.csv", 
          row.names = FALSE)
