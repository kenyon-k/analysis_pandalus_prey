...
prey <- read.csv('data/raw/2019_StomachContent_B.csv') 
...
# 'data.frame':	1236 obs. of  20 variables:
...
# $ Scientific.Name   : chr  "THEMISTO SP" "EMPTY" "THEMISTO SP" "THEMISTO SP" ...
# $ CommonName        : chr  "HYPERID AMPHIPOD" "EMPTY" "HYPERID AMPHIPOD" "HYPERID AMPHIPOD" ...
# $ Aphia_ID          : int  101800 NA 101800 101800 101800 101800 106669 106669 883 123084 ...
# $ Prey_Detail_Code  : int  81 NA 81 81 81 81 81 81 81 81 ...
...
### Import Prey Taxa Data

taxa <- read.csv('data/raw/2019_Prey_WormsTaxa_B.csv') 
# assumes header=TRUE and knows it's separated by commas
...
#   
# $ Prey_OS_ID_DB   : int  6999 6996 6930 4949 7389 6846 8138 810 290 451 ...
# $ ScientificName_W: chr  "Ampelisca eschrichtii" "Ampelisca" "Amphipoda" "Annelida" ...
# $ CommonName_DB   : chr  "GAMMARID AMPHIPOD" "GAMMARID AMPHIPOD" "AMPHIPOD" "ANNELID" ...
# $ Phylum          : chr  "Arthropoda" "Arthropoda" "Arthropoda" "Annelida" ...
# $ Order           : chr  "Amphipoda" "Amphipoda" "Amphipoda" NA ...
...
### Merging prey and taxa by Prey_OS_ID

prey <- left_join(prey, taxa,                                  # joins the 'taxa' data to 'prey'. Retains all prey rows
                  by = c("Prey_OS_ID" = "Prey_OS_ID_DB"),      # appends data where "Prey_OS_ID_DB" exactly matches "Prey_OS_ID"
                  relationship = "many-to-one")                # many rows in prey may match one row in taxa

# view df to confirm that the join happened correctly.
    # same number of observations? 4 more variables?
    # open df. Scientific names from database and WoRMS align? Common names the same? etc
    # join was correct? Continue!



### Remove duplicate columns post join
prey <- prey %>%
  select(-c(Scientific.Name, CommonName, Aphia_ID))  %>%             # removes columns
  relocate(ScientificName_W, CommonName_DB, .after = Prey_OS_ID)     # moves columns to be after Prey_OS_ID
...
# 'data.frame':	1236 obs. of  25 variables:
#   
# $ ContentKey        : chr  "62114003_892_3_1_-14_1733" "62114003_892_3_1_-15_1732" "62114003_892_3_1_-16_1728" "62114003_892_3_1_-17_1729" ...
# $ FishKey           : chr  "62114003_892_3_1_-14" "62114003_892_3_1_-15" "62114003_892_3_1_-16" "62114003_892_3_1_-17" ...
# $ Prey_OS_ID        : int  6967 9998 6967 6967 6967 6967 8020 8020 4950 8530 ...
# $ ScientificName_W  : chr  "Themisto" "Empty" "Themisto" "Themisto" ...
# $ CommonName_DB     : chr  "HYPERID AMPHIPOD" "EMPTY" "HYPERID AMPHIPOD" "HYPERID AMPHIPOD" ...
# $ Prey_Detail_Code  : int  81 NA 81 81 81 81 81 81 81 81 ...
# $ PreyWt            : num  0.3 NA 0.286 0.091 0.079 ...
# $ Prey_Count        : int  NA NA NA NA NA NA NA NA NA NA ...
# $ OS_ID             : int  892 892 892 892 892 892 892 892 892 892 ...
...
# $ Start.Long.Degree : int  60 60 60 60 60 60 60 60 60 60 ...
# $ Start.Long.Minutes: num  24.2 24.2 24.2 24.2 24.2 ...
# $ Phylum            : chr  "Arthropoda" NA "Arthropoda" "Arthropoda" ...
# $ Order             : chr  "Amphipoda" NA "Amphipoda" "Amphipoda" ...
...
# 'data.frame':	644 obs. of  26 variables:
#   
# $ ContentKey        : chr  "62114003_892_3_1_-14_1733" "62114003_892_3_1_-15_1732" "62114003_892_3_1_-16_1728" "62114003_892_3_1_-17_1729" ...
# $ FishKey           : chr  "62114003_892_3_1_-14" "62114003_892_3_1_-15" "62114003_892_3_1_-16" "62114003_892_3_1_-17" ...
